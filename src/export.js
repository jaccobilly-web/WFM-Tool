...
export async function exportToExcel(categories, modelName, modelDescription, numOptions, optionNames) {
  ...
  oRow += 1;
  wsO.mergeCells("B" + oRow + ":C" + oRow);
  sc(wsO, oRow, 2, "Generated by the Weighted Factor Model Builder", { font: { name: "Arial", size: 8, italic: true, color: { argb: "FF94a3b8" } }, align: { horizontal: "left", vertical: "middle" }, noBorder: true });
